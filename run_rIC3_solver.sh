...
process_file() {
    ...
    {
        echo "File: $FILE"
        echo "Command: ~/coding_env/rIC3/target/release/rIC3 -e ic3 --ic3-dynamic $FILE"
        echo "Started at: $(date)"
        echo "----------------------------------------"
        
        # Run the solver with timeout and capture output
        timeout 3600 ~/coding_env/rIC3/target/release/rIC3 -e ic3 --ic3-dynamic "$FILE" 2>&1
